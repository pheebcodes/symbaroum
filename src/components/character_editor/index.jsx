...
import { AbilityList } from "./ability_list.jsx";
import { InventoryList } from "./inventory_list.jsx";
import { ArmorList } from "./armor_list.jsx";
import { WeaponList } from "./weapon_list.jsx";
import { GroupList } from "./group_list.jsx";
import { ArtifactList } from "./artifact_list.jsx";
import { Group, Input, Select, TextArea } from "../form.jsx";
    ...
    <div className="character-editor">
      <CharacterInformation>
        ...
        <Input
          id="total-xp"
          label="Total XP"
          value={character.get("totalXP")}
          type="number"
          onChange={(v) => updateCharacter("totalXP", v)}
        />
        <Input
          id="permanent-corruption"
          label="Permanent Corruption"
          value={character.get("permanentCorruption")}
          type="number"
          onChange={(v) => updateCharacter("permanentCorruption", v)}
        />
        <Input
          id="temporary-corruption"
          label="Temporary Corruption"
          value={character.get("temporaryCorruption")}
          type="number"
        ...
        <TextArea
          id="appearance"
          label="Appearance"
          value={character.get("appearance")}
        ...
        <TextArea
          id="personal-goal"
          label="Personal Goal"
          value={character.get("personalGoal")}
          onChange={(v) => updateCharacter("personalGoal", v)}
        />
        <TextArea
          id="shadow"
          label="Shadow"
          value={character.get("shadow")}
      ...
      <Abilities>
        <AbilityList
          list={character.get("abilities")}
          onChange={(v) => updateCharacter("abilities", v)}
        />
      </Abilities>
      <Equipment>
        <WeaponList
          list={character.get("weapons")}
          onChange={(v) => updateCharacter("weapons", v)}
        />
        <ArmorList
          list={character.get("armor")}
      ...
      <Inventory>
        <Input
          label="Money"
          value={character.get("money")}
          onChange={(v) => updateCharacter("money", v)}
        />
        <Input
          label="Assets"
          value={character.get("assets")}
          onChange={(v) => updateCharacter("assets", v)}
        />
        <InventoryList
          list={character.get("inventory")}
      ...
      <Friends>
        <Input
          label="Group Name"
          value={character.getIn(["group", "name"])}
          onChange={(v) => updateCharacter(["group", "name"], v)}
        />
        <Input
          label="Group Goal"
          value={character.getIn(["group", "goal"])}
          onChange={(v) => updateCharacter(["group", "goal"], v)}
        />
        <GroupList
          list={character.getIn(["group", "members"])}
          onChange={(v) => updateCharacter(["group", "members"], v)}
        />
      </Friends>
      <Artifacts>
        <ArtifactList
          list={character.get("artifacts")}
      ...
      <div className="footer">
        ...
        <Link
          to={`/character/${match.params.id}/print`}
        ...
        <a
          ...
          download={`${character.get("name") || "character"}.json`}
        >
          Download
        </a>
        <button
...
export const CharacterEditor = withRouter(
  connect(mapState, mapDispatch)(CharacterEditorView)
);
